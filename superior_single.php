					...
					<div class="row room-information">
									...
									<div id="myCarousel" class="carousel slide information-slider">
										<div class="carousel-inner">
											<div class="active item" data-slide-number="0">
												...
												<div class="fill" style="background-image:url('images/rooms/superior-single/superior-s1.jpg');"></div>
											</div>
											<div class="item" data-slide-number="1">
												<div class="fill" style="background-image:url('images/rooms/superior-single/superior-s2.jpg');"></div>
											</div>
											<div class="item" data-slide-number="2">
												<div class="fill" style="background-image:url('images/rooms/superior-single/superior-s3.jpg');"></div>
											</div>
											<div class="item" data-slide-number="3">
												<div class="fill" style="background-image:url('images/rooms/superior-single/superior-s4.jpg');"></div>
											</div>
										</div>
								...
								<ul class="list-inline row">
									<li class="col-lg-3 col-xs-3 padding0"> 
										<a id="carousel-selector-0" class="selected">
											<img src="images/rooms/superior-single/superior-sthumb1.jpg" class="img-responsive"/>
										</a>
									</li>
									<li class="col-lg-3 col-xs-3 padding0"> 
										<a id="carousel-selector-1"><img src="images/rooms/superior-single/superior-sthumb2.jpg" class="img-responsive"/></a>
									</li>
									<li class="col-lg-3 col-xs-3 padding0"> 
										<a id="carousel-selector-2"><img src="images/rooms/superior-single/superior-sthumb3.jpg" class="img-responsive"/></a>
									</li>
									<li class="col-lg-3 col-xs-3 padding0"> 
										<a id="carousel-selector-3"><img src="images/rooms/superior-single/superior-sthumb4.jpg" class="img-responsive"/></a>
									</li>
								</ul>
							</div>
						...
						<div class="col-lg-5 col-sm-5 superior-bg">
							<div class="roomtype-title">
								<h3 class="pull-left">SUPERIOR SINGLE</h3>
							...
							<div class="roomtype-information scrollbar"  id="style-1">
								<p>
									Enjoy our most preferred economic room, measuring 10sqm that is well furnished with a comfy single bed and designed with beautiful ceramic tiles bathroom and top quality teakwood wardrobe and desk to facilitate your accommodation here.
								</p>
								...
								<table width="100%">
									...
									<tr>
										<td><span class="avb-title">Extra Bed:</span><br><span class="avb-small-text">Not available with additional cost</span></td>
