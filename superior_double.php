					...
					<div class="row room-information">
									...
									<div id="myCarousel" class="carousel slide information-slider">
						                <div class="carousel-inner">
						                    <div class="active item" data-slide-number="0">
						                        ...
						                        <div class="fill" style="background-image:url('images/rooms/superior-double/superior-d1.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="1">
						                        <div class="fill" style="background-image:url('images/rooms/superior-double/superior-d2.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="2">
						                        <div class="fill" style="background-image:url('images/rooms/superior-double/superior-d3.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="3">
						                        <div class="fill" style="background-image:url('images/rooms/superior-double/superior-d4.jpg');"></div>
						                    </div>
						                </div>
								...
								<ul class="list-inline row">
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-0" class="selected">
							        		<img src="images/rooms/superior-double/superior-dthumb1.jpg" class="img-responsive"/>
							        	</a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-1"><img src="images/rooms/superior-double/superior-dthumb2.jpg" class="img-responsive"/></a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-2"><img src="images/rooms/superior-double/superior-dthumb3.jpg" class="img-responsive"/></a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-3"><img src="images/rooms/superior-double/superior-dthumb4.jpg" class="img-responsive"/></a>
							        </li>
							    </ul>
							</div>
						...
						<div class="col-lg-5 col-sm-5 superior-bg">
							<div class="roomtype-title">
								<h3 class="pull-left">SUPERIOR DOUBLE</h3>
							...
							<div class="roomtype-information scrollbar"  id="style-1">
								<p>
									Our most preferred economic room among travelers, measuring 19sqm. It comes with a comfy double bed that fits two adults easily, fully equipped room amenities, bathroom finished with top quality ceramic tiles and teakwood wardrobe and desk.
								</p>
