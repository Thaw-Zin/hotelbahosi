...
<head>
    ...
    <link rel="canonical" href="http://www.hotelbahosi.com/room">
    ...
    <meta name="twitter:url" content="http://www.hotelbahosi.com/room" />
    ...
    <meta property="og:url" content="http://www.hotelbahosi.com/room" />
				...
				<div class="col-lg-9 col-sm-9 col-xs-12 main-content" id="page_animation">
					<div class="row page-category" style="background-color:#f0f0f0 !important;">
						<div class="col-lg-4 col-xs-4">
							<p class="page-title"><a href="room" class="room-active">DELUXE<br> <span> <span id="room-type" url="deluxe_double"> DOUBLE</span>/ <span id="room-type" url="deluxe_twin">TWIN</span></span> </a></p>
							<img src="images/room-arrow.png" class="pull-right parent-arrow">
						</div>
						<div class="col-lg-4 col-xs-4">
							<p class="page-title"><a href="superior">SUPERIOR<br><span> <span id="room-type" url="superior_single">SINGLE</span>/ <span id="room-type" url="superior_double">DOUBLE</span>/ <span id="room-type"  url="superior_twin">TWIN</span></span></a></p>
							<img src="images/room-arrow.png" class="pull-right parent-arrow">
						</div>
						<div class="col-lg-4 col-xs-4">
									...
									<div id="myCarousel" class="carousel slide information-slider">
						                <div class="carousel-inner">
						                    <div class="active item" data-slide-number="0">
						                        ...
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-twin/deluxe-t1.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="1">
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-twin/deluxe-t2.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="2">
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-twin/deluxe-t3.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="3">
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-twin/deluxe-t4.jpg');"></div>
						                    </div>
						                </div>
								...
								<ul class="list-inline row">
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-0" class="selected">
							        		<img src="images/rooms/deluxe-twin/deluxe-tthumb1.jpg" class="img-responsive"/>
							        	</a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-1"><img src="images/rooms/deluxe-twin/deluxe-tthumb2.jpg" class="img-responsive"/></a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-2"><img src="images/rooms/deluxe-twin/deluxe-tthumb3.jpg" class="img-responsive"/></a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-3"><img src="images/rooms/deluxe-twin/deluxe-tthumb4.jpg" class="img-responsive"/></a>
							        </li>
							    </ul>
							</div>

						</div>
						<div class="col-lg-5 col-sm-5 deluxe-bg">
							<div class="roomtype-title">
								<h3 class="pull-left">DELUXE TWIN</h3>
							...
							<div class="roomtype-information scrollbar"  id="style-1">
								<p>
									Furnished with teak floor tiles and teakwood furniture and a set of relaxing twin bed. Its amenities include bathroom with top quality ceramic tiles, an electronic safe, hair dryer and coffee & tea set.
								</p>
								<hr class="line-divider">
								<table width="100%">
									<tr>
										<td><span class="avb-title">Bed Type:</span><br><span class="avb-small-text">Double, Twin</span></td>
									...
									<tr>
										...
										<td><span class="avb-title">Child Policy:</span><br><span class="avb-small-text"> Free for age 5 & under</span></td>
									</tr>
								</table>
								<hr class="line-divider">
								<div class="row">
