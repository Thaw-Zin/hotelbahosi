	...
	<div class="container-fulid">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-9 col-sm-9 main-content" id="page_animation">
					...
					<div class="row">
						<div class="col-lg-12 padding0">
							<div id="myCarousel" class="carousel slide room-slider">
								<!-- Indicators -->
								...
								<div class="carousel-inner">
									<div class="item active">
										...
										<div class="fill" style="background-image:url('images/rooms/Superior-S.jpg');"></div>
										<div class="carousel-caption room-caption">
											<div class="room-info info-mobile"><a href="superior_single">ROOM INFO </a></div>
											<a href="deluxe_double" class="link-dollar">
												<div class="dollar"> <span>SUPERIOR</span><h3>SINGLE</h3></div>
												<div class="mb-dollar"><span>SUPERIOR SINGLE</span></div>
											</a>
											<div class="room-info info-mobile1"><a onClick="OpenBook('FrmBook');" style="cursor:pointer;" target="_blank">BOOK NOW </a></div>
										</div>
									</div>
									<div class="item">
										<div class="fill" style="background-image:url('images/rooms/Superior-D.jpg');"></div>
										<div class="carousel-caption room-caption">
											<div class="room-info info-mobile"><a href="superior_double">ROOM INFO </a></div>
											<a href="deluxe_double" class="link-dollar">
												<div class="dollar"> <span>SUPERIOR</span><h3>DOUBLE</h3></div>
												<div class="mb-dollar"><span>SUPERIOR DOUBLE</span></div>
											</a>
											<div class="room-info info-mobile1"><a onClick="OpenBook('FrmBook');" style="cursor:pointer;" target="_blank">BOOK NOW </a></div>
										</div>
									</div>
									<div class="item">
										<div class="fill" style="background-image:url('images/rooms/Superior-T.jpg');"></div>
										<div class="carousel-caption room-caption">
											<div class="room-info info-mobile"><a href="superior_twin">ROOM INFO </a></div>
											<a href="deluxe_double" class="link-dollar">
												<div class="dollar"> <span>SUPERIOR</span><h3>TWIN</h3></div>
												<div class="mb-dollar"><span>SUPERIOR TWIN</span></div>
											</a>
											<div class="room-info info-mobile1"><a onClick="OpenBook('FrmBook');" style="cursor:pointer;" target="_blank">BOOK NOW </a></div>
										</div>
									</div>
