					...
					<div class="row room-information">
									...
									<div id="myCarousel" class="carousel slide information-slider">
						                <div class="carousel-inner">
						                    <div class="active item" data-slide-number="0">
						                        ...
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-double/deluxe-d1.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="1">
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-double/deluxe-d2.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="2">
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-double/deluxe-d3.jpg');"></div>
						                    </div>
						                    <div class="item" data-slide-number="3">
						                        <div class="fill" style="background-image:url('images/rooms/deluxe-double/deluxe-d4.jpg');"></div>
						                    </div>
						                </div>
								...
								<ul class="list-inline row">
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-0" class="selected">
							        		<img src="images/rooms/deluxe-double/deluxe-dthumb1.jpg" class="img-responsive"/>
							        	</a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-1"><img src="images/rooms/deluxe-double/deluxe-dthumb2.jpg" class="img-responsive"/></a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-2"><img src="images/rooms/deluxe-double/deluxe-dthumb3.jpg" class="img-responsive"/></a>
							        </li>
							        <li class="col-lg-3 col-xs-3 padding0"> 
							        	<a id="carousel-selector-3"><img src="images/rooms/deluxe-double/deluxe-dthumb4.jpg" class="img-responsive"/></a>
							        </li>
							    </ul>
							</div>
						...
						<div class="col-lg-5 col-sm-5 deluxe-bg">
							<div class="roomtype-title">
								<h3 class="pull-left">DELUXE DOUBLE</h3>
							...
							<div class="roomtype-information scrollbar"  id="style-1">
								<p>
									This 19sqm traditional room features a homely double bed with the best teak floor tiles and teakwood furniture. Its amenities include bathroom with top quality ceramic tiles, an electronic safe, hair dryer and coffee & tea set. 
								</p>
